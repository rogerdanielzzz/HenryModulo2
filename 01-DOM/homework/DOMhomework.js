...
// Tu código acá:
document.getElementById('createdBy').innerHTML = "Aplicación creada por Roger Pérez"
...
function buildToDos(toDos) {
  // Tu código acá:
  let toDoArray = toDos.map(buildToDo)
  return toDoArray
...
function displayToDos() {
  ...
  for (let i = 0; i < newArray.length; i++) {
    toDoContainer.append(newArray[i])
  }
...
function addToDo() {
  ...
  let objeto = new ToDo(toDoInput)
  toDoItems.push(objeto)
  toDoInput.innerHTML = ""
  displayToDos()
}
